$(function () {
  ...
  $('.product-items-active').slick({
    ...
    adaptiveHeight: true,
    arrows: true,
    prevArrow: '<span class="prev"><i class="lni-chevron-left" style="margin-top: -25px;"></i></span>',
    nextArrow: '<span class="next"><i class="lni-chevron-right" style="margin-top: -25px;"></i></span>',
    responsive: [
      {
        breakpoint: 1200,
        settings: {
